...
@Repository
public interface SocialUserRepository extends PagingAndSortingRepository<SocialUser, Long>, SocialUserRepositoryCustom {
	...
	List<SocialUser> findsByProviderIdAndProviderUserId(@Param("providerId") String providerId, @Param("providerUserId") String providerUserId);
	...
	SocialUser findByUserIdAndProviderIdAndProviderUserId(@Param("userId") String userId, @Param("providerId") String providerId, @Param("providerUserId") String providerUserId);
	...
	List<String> findUsersConnectedTo(@Param("providerId") String providerId, @Param("providerUserIds") Set<String> providerUserIds);
