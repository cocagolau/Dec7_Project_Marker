...
//	public static final String DEFAULT_SLIPP_USER_PROFILE_SUFFIX = "http://www.gravatar.com/avatar/";
	...
	public boolean isSLiPPUser() {
		return ProviderType.Marker == getProviderIdBySnsType();
	}
...
//		String oldEncodedPassword = encoder.encodePassword(oldPassword, null);
		String oldEncodedPassword = encoder.encode(oldPassword);
...
//		}
	...
	public String toString() {
		return "SocialUser [id=" + id + ", userId=" + userId + ", password=" + password + ", rawPassword="
				+ rawPassword + ", email=" + email + ", providerId=" + providerId + ", providerUserId="
				...
				+ refreshToken + ", expireTime=" + expireTime + ", createDate=" + createDate + ", blocked=" + blocked
				+ "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((rawPassword == null) ? 0 : rawPassword.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (rawPassword == null) {
			if (other.rawPassword != null)
				return false;
		} else if (!rawPassword.equals(other.rawPassword))
			return false;
