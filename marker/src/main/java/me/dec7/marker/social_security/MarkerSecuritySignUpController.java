...
import me.dec7.marker.domain.user.ExistedUserException;
...
public class MarkerSecuritySignUpController {
	private String authenticateUrl = MarkerSecurityAuthenticationFilter.DEFAULT_AUTHENTICATION_URL;
